...
import iamge from '../../assets/image/banner.jpg'
...
const Blog = () => {
    return (
     ...
     <div className="row container-fluid mb-5">
         <h2 className="text-center text-success">Reads Blog</h2>
         <div className="col-lg-6 col-sm-12">
            <img className="w-100 h-100" src={iamge} alt="" />
         </div>
         <div className="col-lg-6 col-sm-12">
          <div className="accordion" id="accordionExample">
             <div className="accordion-item">
                <h2 className="accordion-header" id="headingTwo">
                  <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">        Blog description -1
                    </button>
                    </h2>
